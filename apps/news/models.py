...
class Post(SEOMixin):
    ...
    content = models.TextField(help_text="Full post body. Supports rich text formatting.")
    ...
    is_published = models.BooleanField(default=False, db_index=True, help_text="Check to make this post visible on the website.")
